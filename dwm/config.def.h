static const char *fonts[]          = { "WenQuanYi Micro Hei Mono Light:size=12" };
static const char dmenufont[]       = "WenQuanYi Micro Hei Mono Light:size=12";
...
static const char *screencaptur[]        = { "scrot", NULL };
static const char *screencapturbyrect[]  = { "scrot", "-s", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Print,  spawn,         {.v = screencaptur } },
	{ Mod1Mask,                     XK_Print,  spawn,         {.v = screencapturbyrect } },
};
